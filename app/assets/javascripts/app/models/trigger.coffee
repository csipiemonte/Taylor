class App.Trigger extends App.Model
  ...
  @configure_attributes = [
    ...
    { name: 'condition',  display: 'Conditions for effected objects', tag: 'ticket_selector', null: false, preview: false, action: true, hasChanged: true, executionTime: true, externalActivity: true },
    { name: 'perform',    display: 'Execute changes on objects',      tag: 'ticket_perform_action', null: true, notification: true, externalActivity: true, trigger: true },
