class App.Trigger extends App.Model
  ...
  @configure_attributes = [
    ...
    { name: 'condition',  display: __('Conditions for affected objects'), tag: 'ticket_selector', null: false, preview: false, action: true, hasChanged: true, executionTime: true, externalActivity: true },
    { name: 'perform',    display: __('Execute changes on objects'),      tag: 'ticket_perform_action', null: true, notification: true, externalActivity: true, trigger: true },
