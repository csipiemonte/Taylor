...
App.Config.set('Whatsapp', { prio: 5200, name: 'Whatsapp', parent: '#channels', target: '#channels/whatsapp', controller: Index, permission: ['admin.channel_whatsapp'] }, 'NavBarAdmin')
