...
RSpec.describe 'ImportFreshdesk', type: :request, set_up: false, external_env: true, authenticated_as: false, required_envs: %w[IMPORT_FRESHDESK_ENDPOINT_SUBDOMAIN] do
  let(:action) { nil }
